...
/* ── Sidebar (Logistics-active variant) ──────────────────────────────────── */
const LogisticsSidebar = () => {
    const navigate = useNavigate();

    const menuItems = [
        { name: 'Dashboard', icon: 'grid' },
        { name: 'Logistics', icon: 'trending', active: true },
    ...
    return (
        <div className="lp-sidebar">
            <div className="lp-sidebar-header">
                <h1 className="lp-sidebar-logo">Ascendly</h1>
                <p className="lp-sidebar-subtitle">STARTUPS DASHBOARD</p>
            </div>
            ...
            <nav className="lp-sidebar-nav">
                {menuItems.map((item) => (
                    <a
                        key={item.name}
                        href="#"
                        className={`lp-sidebar-nav-item${item.active ? ' active' : ''}`}
                        onClick={(e) => {
                            e.preventDefault();
            ...
            <div className="lp-sidebar-footer">
                <div className="lp-sidebar-upgrade">
                    <p>Upgrade to <strong>PRO</strong> to get access to all features!</p>
                </div>
                <a href="#" className="lp-sidebar-help">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
