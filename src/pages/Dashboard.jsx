  ...
  return (
    ...
    <div className="dashboard-page">
      ...
      />
        ...
        <MetricCard icon={<i className="fi fi-sr-chart-simple-horizontal"></i>} 
         title="Engagement Score" 
         value="81/100" 
         chartType="circle" />


        {/* Added specific styling for the Growth card to match UI */}
        {/* Growth – styled same as Active Users */}
      ...
      <div className="content-grid">
        ...
        <div className="card forecast-card">
          ...
          <div className="forecast-content">
            ...
            {/* Updated SVG to be a smooth Curve (Bezier) instead of Polyline */}
            <div className="chart-placeholder">
        <svg viewBox="0 0 500 150" className="line-chart" preserveAspectRatio="none">
         <defs>
      {/* Gradient for the fill under the curve */}
